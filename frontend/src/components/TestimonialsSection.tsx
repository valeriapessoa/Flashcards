...
const testimonials = [
  ...
  },
  {
    ...
    content:
      "Adotar o sistema de flashcards foi um divisor de águas na minha rotina de estudos. Ele adapta os conteúdos com base no meu desempenho, o que torna a revisão mais estratégica e personalizada.",
